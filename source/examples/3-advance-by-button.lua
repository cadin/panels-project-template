    ...
    panels = {
        ...
        { -- panel 2 
            ...
            layers = {
                ...
                { images = {"examples/ex3/1-bubbleB.png", "examples/ex3/1-bubbleA.png","examples/ex3/1-bubbleB.png"},  parallax = 0.1 },
    ...
    panels = {
        ...
        { -- panel 2 
            ...
            layers = {
                ...
                -- speech bubble (2 versions)
                { images = {"examples/ex3/1-bubbleA.png","examples/ex3/1-bubbleB.png"}, 
